...
export const offices: Office[] = [
    {
        ...
        type: 'Transition',
        area: 'Tenmonkan',
        support_benefits: ['昼食無料', '資格受験料補助（記載あり）'],
        job_programs: ['PC訓練（Word/Excelなど）', '資格学習（MOS/CS検定など）', '生活訓練・軽作業'],
        job_hunt_support: ['求人検索サポート', '履歴書作成・面接練習', 'ハローワーク同行'],
    ...
    },
    {
        ...
        type: 'Transition',
        area: 'Other',
        support_benefits: ['昼食提供あり（外部DB補完）'],
        job_programs: ['座学・グループワーク', 'JST・施設内外作業', '企業見学・職場実習'],
        job_hunt_support: ['ハローワーク相談・同行', '面接同行', '就職後の職場訪問'],
    ...
    },
    {
        ...
        type: 'Transition',
        area: 'Other',
        support_benefits: ['昼食提供 200円（外部DB補完）'],
        job_programs: ['ビジネスマナー', '履歴書・面接練習', 'PC訓練・企業実習'],
        job_hunt_support: ['応募書類作成支援', '面接練習', '就労定着支援'],
    ...
    },
    {
        ...
        type: 'Transition',
        area: 'ChuoStation',
        support_benefits: ['補助情報は公式未掲載'],
        job_programs: ['就労準備訓練', 'オフィスワークシミュレーション', '復職支援（リワーク）'],
        job_hunt_support: ['就職活動支援', '定着支援'],
    ...
    },
    {
        ...
        type: 'Transition',
        area: 'Tenmonkan',
        support_benefits: ['在宅PCレンタルは未掲載（要確認）'],
        job_programs: ['eラーニング学習', 'PC/IT訓練', '企業見学・実習'],
        job_hunt_support: ['応募書類添削', '面接練習', '就職後フォロー面談'],
    ...
    },
    {
        ...
        type: 'Transition',
        area: 'Other',
        support_benefits: ['昼食提供（記載あり）'],
        job_programs: ['自己理解プログラム', '軽作業訓練', '日課プログラム（パンフ）'],
        job_hunt_support: ['就職支援の詳細は見学時に確認'],
